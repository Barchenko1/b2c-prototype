...
import com.b2c.prototype.modal.dto.request.SingleOptionItem;
...
class OptionItemServiceTest {
    ...
    void testSaveUpdateOptionItemSetByArticularId() {
        ...
        optionItemService.saveUpdateOptionItemSetByArticularId(dtoUpdate);
    ...
    void testSaveUpdateOptionItemSetByOptionGroupName() {
        ...
        optionItemService.saveUpdateOptionItemSetByOptionGroupName(optionItemDto);
    ...
    void testDeleteOptionItemByArticularId() {
        ...
        optionItemService.deleteOptionItemByArticularId(dto);
    ...
    void testDeleteOptionItemByOptionGroupName() {
        ...
        optionItemService.deleteOptionItemByOptionGroupName(multipleFieldsSearchDtoDelete);
    ...
    void testGetOptionItemByItemArticularId() {
        ...
        OptionItemDto result = optionItemService.getOptionItemByItemArticularId(oneFieldEntityDto);
    ...
    void testGetOptionItemListByOptionGroup() {
        ...
        List<OptionItemDto> result = optionItemService.getOptionItemListByOptionGroup(oneFieldEntityDto);
    ...
    void testGetOptionItemList() {
        ...
        List<OptionItemDto> result = optionItemService.getOptionItemList();
