...
class StoreServiceTest {
    ...
    void testDeleteStore() {
        ...
        when(supplierService.parameterStringSupplier(ARTICULAR_ID, oneFieldEntityDto.getValue()))
                .thenReturn(parameterSupplier);
        Function<ItemDataOption, Store> function = mock(Function.class);
        when(transformationFunctionService.getTransformationFunction(ItemDataOption.class, Store.class))
                .thenReturn(function);
        ...
        storeService.deleteStore(oneFieldEntityDto);
    ...
    void testGetAllStoreResponse() {
        ...
        List<ResponseStoreDto> result = storeService.getAllStoreResponse();
