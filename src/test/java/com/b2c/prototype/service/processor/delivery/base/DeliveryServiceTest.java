...
class DeliveryServiceTest {
    ...
    void testSaveUpdateDelivery() {
        ...
        deliveryService.saveUpdateDelivery(deliverySearchFieldEntityDto);
    ...
    void testDeleteDelivery() {
        ...
        deliveryService.deleteDelivery(oneFieldEntityDto);
    ...
    void testGetDelivery() {
        ...
        DeliveryDto result = deliveryService.getDelivery(oneFieldEntityDto);
    ...
    void testGetDeliveries() {
        ...
        List<DeliveryDto> resultList = deliveryService.getDeliveries();
