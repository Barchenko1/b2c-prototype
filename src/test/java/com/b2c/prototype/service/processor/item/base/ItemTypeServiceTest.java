...
class ItemTypeServiceTest extends AbstractOneFieldEntityServiceTest<ItemType> {
    ...
    public void testGetEntity() {
        ...
        ResponseOneFieldEntityDto result = itemTypeService.getEntity(dto);
    ...
    public void testGetEntityOptional() {
        ...
        Optional<ResponseOneFieldEntityDto> result = itemTypeService.getEntityOptional(dto);
    ...
    public void testGetEntities() {
        ...
        List<ResponseOneFieldEntityDto> list = itemTypeService.getEntities();
