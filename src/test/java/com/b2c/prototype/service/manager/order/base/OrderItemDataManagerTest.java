...
class OrderItemDataManagerTest {
    ...
    @InjectMocks
    private OrderItemDataManager orderItemDataManager;
    ...
    void saveOrderItemData_shouldSaveEntity() {
        ...
        orderItemDataManager.saveOrderItemData(dto);
    ...
    void updateOrderItemData_shouldUpdateEntity() {
        ...
        orderItemDataManager.updateOrderItemData(dtoUpdate);
    ...
    void deleteOrderItemData_shouldDeleteEntity() {
        ...
        orderItemDataManager.deleteOrderItemData(dto);
    ...
    void getOrderItemData_shouldReturnDto() {
        ...
        ResponseOrderItemDataDto result = orderItemDataManager.getResponseOrderItemData(dto);
    ...
    void getOrderItemListData_shouldReturnDtoList() {
        ...
        List<ResponseOrderItemDataDto> list = orderItemDataManager.getResponseOrderItemDataList();
