...
class SingleDeliveryOrderDaoTest extends AbstractCustomEntityDaoTest {

    @BeforeAll
    public static void setup() {
        IEntityMappingManager entityMappingManager = new EntityMappingManager();
        entityMappingManager.addEntityTable(new EntityTable(DeliveryArticularItemQuantity.class, "customer_order"));
        queryService = new QueryService(entityMappingManager);
        dao = new GeneralEntityDao();
    }
...
//                .addresses(Set.of(createAddress()))
    ...
    private MetaData prepareTestItemData() {
...
//                .articularItemQuantityPriceList(List.of(articularItemQuantity))
...
//        orderItemDataOption.getPayment().getCreditCard().setId(1L);
    ...
    void getEntityList_success() {
        ...
        List<DeliveryArticularItemQuantity> resultList = dao.findEntityList("", (List<Pair<String, ?>>) parameter);
...
//            dao.getNamedQueryEntity("", parameter);
    ...
    void saveEntityWithDependencies_success() {
        ...
        verifyExpectedData("/datasets/order/customer_order/saveOrderArticularItem.yml");
    }
...
//            dao.executeConsumer(consumer);
        ...
        verifyExpectedData("/datasets/order/customer_order/emptyCustomerOrder.yml");
    }
...
//
//            ArticularItemQuantity articularItemQuantity = deliveryArticularItemQuantity.getArticularItemQuantityPriceList().get(0);
//
//            s.merge(articularItemQuantity);
//            deliveryArticularItemQuantity.setArticularItemQuantityPriceList(List.of(articularItemQuantity));
...
//            dao.deleteEntity(orderItemDataOption);
    ...
    void getOptionalEntityWithDependencies_success() {
        ...
        Optional<DeliveryArticularItemQuantity> resultOptional =
                dao.findOptionEntity("", (List<Pair<String, ?>>) parameter);
...
//        DeliveryArticularItemQuantity result = dao.getNamedQueryEntity("", parameter);
        ...
        checkOrderItem(orderItemDataOption, null);
    }
