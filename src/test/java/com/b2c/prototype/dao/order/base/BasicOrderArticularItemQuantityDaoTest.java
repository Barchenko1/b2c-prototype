...
class BasicOrderArticularItemQuantityDaoTest extends AbstractCustomEntityDaoTest {

    @BeforeAll
    public static void setup() {
        IEntityMappingManager entityMappingManager = new EntityMappingManager();
        entityMappingManager.addEntityTable(new EntityTable(OrderArticularItemQuantity.class, "order_articular_item"));
...
//                .addresses(Set.of(createAddress()))
    ...
    private OrderArticularItemQuantity prepareTestOrderItemData() {
        ...
        OrderArticularItemQuantity orderItemDataOption = OrderArticularItemQuantity.builder()
                .id(1L)
//                .dateOfCreate(100L)
...
//        orderItemDataOption.getPayment().getCreditCard().setId(1L);
    ...
    private OrderArticularItemQuantity prepareSaveOrderItem() {
...
//                .note("note")
    ...
    private OrderArticularItemQuantity prepareUpdateOrderItem() {
        ArticularItemQuantity articularItemQuantity = prepareTestOrderItemQuantity();
        articularItemQuantity.setId(1L);
        UserDetails userDetails = prepareTestUserDetails();
        userDetails.getContactInfo().setId(1L);
...
//        orderItemDataOption.getPayment().getCreditCard().setId(1L);
    ...
    private void checkOrderItem(OrderArticularItemQuantity expectedOrderItemDataOption, OrderArticularItemQuantity actualOrderItemDataOption) {
    ...
    void getEntityList_success() {
        ...
        OrderArticularItemQuantity orderItemDataOption = prepareTestOrderItemData();
        List<OrderArticularItemQuantity> resultList = dao.getNamedQueryEntityList("", parameter);
    ...
    void saveEntityWithDependencies_success() {
        ...
        OrderArticularItemQuantity orderItemDataOption = prepareSaveOrderItem();
    ...
    void updateEntity_transactionFailure() {
        Supplier<OrderArticularItemQuantity> supplier = () -> {
            throw new RuntimeException();
        };
    ...
    void updateEntityConsumer_success() {
        loadDataSet("/datasets/order/order_articular_item/testOrderArticularItem.yml");
        Consumer<Session> consumer = (Session s) -> {
            OrderArticularItemQuantity orderArticularItemQuantity = prepareUpdateOrderItem();
            Address address = orderArticularItemQuantity.getDelivery().getAddress();
            s.merge(address);
            orderArticularItemQuantity.getDelivery().setAddress(address);
//            orderArticularItemQuantity.getUserDetails().setAddresses(Set.of(address));
//
//            CreditCard creditCard = orderArticularItemQuantity.getPayment().getCreditCard();
//            s.merge(creditCard);
//            orderArticularItemQuantity.getPayment().setCreditCard(creditCard);
//            Set<UserCreditCard> userCreditCardList = orderArticularItemQuantity.getUserDetails().getUserCreditCardList();
//            userCreditCardList.forEach(s::merge);
//            orderArticularItemQuantity.getUserDetails().setUserCreditCardList(userCreditCardList);
//
//            ContactInfo contactInfo = orderArticularItemQuantity.getUserDetails().getContactInfo();
//            Beneficiary beneficiary = orderArticularItemQuantity.getBeneficiaries().get(0);
//            s.merge(contactInfo);
//            s.merge(beneficiary);
//            orderArticularItemQuantity.setBeneficiaries(List.of(beneficiary));
//            orderArticularItemQuantity.getUserDetails().setContactInfo(contactInfo);
//
//            ArticularItemQuantity articularItemQuantity = orderArticularItemQuantity.getArticularItemQuantityList().get(0);
//
//            s.merge(articularItemQuantity);
//            orderArticularItemQuantity.setArticularItemQuantityList(List.of(articularItemQuantity));

            s.merge(orderArticularItemQuantity);
        };
        dao.executeConsumer(consumer);
    ...
    void getOptionalEntityWithDependencies_success() {
        ...
        Parameter parameter = new Parameter("id", 1L);
        OrderArticularItemQuantity orderItemDataOption = prepareTestOrderItemData();
        Optional<OrderArticularItemQuantity> resultOptional =
                dao.getNamedQueryOptionalEntity("", parameter);

        assertTrue(resultOptional.isPresent());
        OrderArticularItemQuantity result = resultOptional.get();
        checkOrderItem(orderItemDataOption, result);
    }
    ...
    void getEntityWithDependencies_success() {
        ...
        OrderArticularItemQuantity orderItemDataOption = prepareTestOrderItemData();
        OrderArticularItemQuantity result = dao.getNamedQueryEntity("", parameter);
