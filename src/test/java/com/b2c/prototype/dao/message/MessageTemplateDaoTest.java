...
class MessageTemplateDaoTest extends AbstractDaoTest {
    ...
    @Test
    @DataSet(value = "datasets/dao/message/message_template/emptyMessageTemplateDataSet.yml", cleanBefore = true)
    @ExpectedDataSet(value = "datasets/dao/message/message_template/saveMessageTemplateDataSet.yml", orderBy = "id")
    ...
    @Test
    @DataSet(value = "datasets/dao/message/message_template/testMessageTemplateDataSet.yml", cleanBefore = true)
    @ExpectedDataSet(value = "datasets/dao/message/message_template/updateMessageTemplateDataSet.yml", orderBy = "id")
...
//        entity.setValue("Update New");
    ...
    @Test
    @DataSet(value = "datasets/dao/message/message_template/testMessageTemplateDataSet.yml", cleanBefore = true)
    @ExpectedDataSet(value = "datasets/dao/message/message_template/emptyMessageTemplateDataSet.yml", orderBy = "id")
