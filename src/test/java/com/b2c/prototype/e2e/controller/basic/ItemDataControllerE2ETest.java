...
class ItemDataControllerE2ETest extends BasicE2ETest {
    ...
    private static final String URL_TEMPLATE = "/api/v1/item-data";
...
//            statement.execute("TRUNCATE TABLE item_data RESTART IDENTITY CASCADE");
//            statement.execute("ALTER SEQUENCE item_data_id_seq RESTART WITH 1");
            connection.commit();
        } catch (Exception e) {
