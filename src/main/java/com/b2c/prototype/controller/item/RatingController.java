...
@RestController
@RequestMapping("/api/v1/item/review/rating")
public class RatingController {
    private final IRatingProcess ratingProcess;

    public RatingController(IRatingProcess ratingProcess) {
    ...
    public ResponseEntity<String> saveConstantEntity(@RequestBody Map<String, Object> payload) {
        ratingProcess.persistEntity(payload);
    ...
    public ResponseEntity<String> putConstantEntity(@RequestBody Map<String, Object> payload,
        ...
        ratingProcess.mergeEntity(payload, value);
        return ResponseEntity.ok().build();
    }
