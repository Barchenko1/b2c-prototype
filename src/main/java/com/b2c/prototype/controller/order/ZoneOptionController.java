...
public class ZoneOptionController {
    ...
    public ResponseEntity<String> saveConstantEntity(@RequestBody ZoneOptionDto payload) {
        zoneOptionProcess.persistEntity(payload);
        return ResponseEntity.ok().build();
    }

    @PutMapping(produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<String> putConstantEntity(@RequestBody ZoneOptionDto payload,
    ...
    public ResponseEntity<String> patchConstantEntity(@RequestBody ZoneOptionDto payload,
                                                      @RequestParam(value = "value") final String value) {
        zoneOptionProcess.mergeEntity(payload, value);
        return ResponseEntity.ok().build();
    }
