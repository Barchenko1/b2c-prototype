...
public class TimeDurationOptionController {
    ...
    public ResponseEntity<Void> putTimeDurationOption(@RequestParam final Map<String, String> requestParams,
                                                      @RequestBody final TimeDurationOptionDto timeDurationOptionDto) {
        timeDurationOptionProcess.mergeEntity(requestParams, timeDurationOptionDto);
        return ResponseEntity.ok().build();
    }

    @PatchMapping(produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Void> patchTimeDurationOption(@RequestParam final Map<String, String> requestParams,
                                                        @RequestBody final TimeDurationOptionDto timeDurationOptionDto) {
        timeDurationOptionProcess.mergeEntity(requestParams, timeDurationOptionDto);
        return ResponseEntity.ok().build();
    }
    ...
    public ResponseEntity<Void> deleteTimeDurationOption(@RequestParam final Map<String, String> requestParams) {
        timeDurationOptionProcess.removeEntity(requestParams);
        return ResponseEntity.ok().build();
    }

    @GetMapping(produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<TimeDurationOptionDto> getTimeDurationOption(@RequestParam final Map<String, String> requestParams) {
        return new ResponseEntity<>(timeDurationOptionProcess.getEntity(requestParams), HttpStatus.OK);
    }

    @GetMapping(value = "/all", produces = MediaType.APPLICATION_JSON_VALUE)
    public List<TimeDurationOptionDto> getTimeDurationOptionList(@RequestParam final Map<String, String> requestParams) {
        return timeDurationOptionProcess.getEntities(requestParams);
    }
}
