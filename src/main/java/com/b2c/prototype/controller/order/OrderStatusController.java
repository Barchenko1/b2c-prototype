...
public class OrderStatusController {
    private final IOrderStatusProcessor orderStatusProcessor;

    public OrderStatusController(IOrderStatusProcessor orderStatusProcessor) {
    ...
    public ResponseEntity<String> saveConstantEntity(@RequestBody Map<String, Object> payload) {
        orderStatusProcessor.persistEntity(payload);
    ...
    public ResponseEntity<String> putConstantEntity(@RequestBody Map<String, Object> payload,
        ...
        orderStatusProcessor.mergeEntity(payload, value);
        return ResponseEntity.ok().build();
    }
