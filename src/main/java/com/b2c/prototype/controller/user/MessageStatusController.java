...
@RestController
@RequestMapping("/api/v1/user/message/status")
public class MessageStatusController {

    private final IMessageStatusProcess messageStatusProcess;

    public MessageStatusController(IMessageStatusProcess messageStatusProcess) {
        this.messageStatusProcess = messageStatusProcess;
    }

    @PostMapping(produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<String> saveConstantEntity(@RequestBody Map<String, Object> payload) {
        messageStatusProcess.persistEntity(payload);
    ...
    public ResponseEntity<String> putConstantEntity(@RequestBody Map<String, Object> payload,
        ...
        messageStatusProcess.mergeEntity(payload, value);
        return ResponseEntity.ok().build();
    }
