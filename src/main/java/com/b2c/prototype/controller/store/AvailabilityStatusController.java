...
@RestController
@RequestMapping("/api/v1/store/stock/status")
public class AvailabilityStatusController {
    private final IAvailabilityStatusProcess availabilityStatusProcess;

    public AvailabilityStatusController(IAvailabilityStatusProcess availabilityStatusProcess) {
        this.availabilityStatusProcess = availabilityStatusProcess;
    }

    @PostMapping(produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<String> saveConstantEntity(@RequestBody Map<String, Object> payload) {
        availabilityStatusProcess.persistEntity(payload);
    ...
    public ResponseEntity<String> putConstantEntity(@RequestBody Map<String, Object> payload,
        ...
        availabilityStatusProcess.mergeEntity(payload, value);
        return ResponseEntity.ok().build();
    }
