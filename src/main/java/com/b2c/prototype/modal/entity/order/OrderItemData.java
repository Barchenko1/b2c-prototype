...
public class OrderItemData {
    ...
    @JoinTable(
            name = "orderitemdata_quantityitem",
            joinColumns = {@JoinColumn(name = "orderitem_id")},
            inverseJoinColumns = {@JoinColumn(name = "itemdataquantity_id")}
    )
    @Builder.Default
    @EqualsAndHashCode.Exclude
    private Set<ItemDataOptionQuantity> itemDataOptionQuantitySet = new HashSet<>();
    @ManyToOne(fetch = FetchType.LAZY, cascade = CascadeType.MERGE)
